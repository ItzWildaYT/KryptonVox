...
container.style.width = '700px';  // adjust as needed
container.style.height = '500px'; // adjust as needed
...
ver.innerHTML = 'Krypton - ItzWildaYT';
ver.title = 'version 8 July 2025';
...
enableLabel.textContent = 'Custom Crosshair';
...
trlabel.textContent = 'Auto-Translate (Chat)';
...
function initializeScript() {
  ...
  const languages={ja:"Japanese",ko:"Korean","zh-CN":"Chinese (Simplified)","zh-TW":"Chinese (Traditional)",fr:"French",de:"German",es:"Spanish",ru:"Russian",ar:"Arabic",it:"Italian",pt:"Portuguese",nl:"Dutch",tr:"Turkish",pl:"Polish",id:"Indonesian",th:"Thai",vi:"Vietnamese",hi:"Hindi",sv:"Swedish",tl:"Tagalog"};
	...
	translatelabel.textContent = 'Translator (Translate Your Messages)';
...
function createKeybindForm() {
	...
	cssContainer.style.top = '50%';
	cssContainer.style.left = 'calc(50% + 380px)'; 
	cssContainer.style.transform = 'translateY(-50%)';
	...
	cssContainer.style.border = '3px solid #555555';
